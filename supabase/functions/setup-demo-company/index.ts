    ...
    for (const employee of createdEmployees) {
      ...
      const diagnosticVariations = [
        { // High performer, engaged
          ...
          daily_energy_level: 'high',
          would_stay_if_offered_similar: 'definitely yes',
        ...
        { // Struggling, at risk
          ...
          would_stay_if_offered_similar: 'probably not',
        ...
        { // Steady performer
          ...
          daily_energy_level: 'moderate',
          would_stay_if_offered_similar: 'yes',
        ...
        { // Disengaged but capable
          ...
          daily_energy_level: 'moderate',
          would_stay_if_offered_similar: 'maybe',
